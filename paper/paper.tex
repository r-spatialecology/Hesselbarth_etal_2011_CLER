...
In total, the survey was answered by 94 people, of which the the majority were either ``PhD students'' (33\%), followed by ``Post-Docs'' (26.6\%) and ``Professors'' (12.8\%). Other less frequent answers were ``data scientists'', ``government employees'' or ``bachelor's and master's degree students''.
...
Interestingly, most people used the raster data model (70.2\%) in comparison to the vector data model (29.8\%).

\begin{center}\includegraphics{paper_files/figure-latex/used_package-1} \end{center}

...
Also the popular plotting package \emph{ggplot2} \cite{Wickham2016} has an extension especially designed for plotting spatial data named \emph{ggspatial} \cite{Dunnington2020}.
...
R packages \emph{geoR} \cite{Diggle2007} and \emph{gstat} \cite{Pebesma2004} provide functionality for this type of analysis, as well as interpolation methods, known as (co-)kriging.

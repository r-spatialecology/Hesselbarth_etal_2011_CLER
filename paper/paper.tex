...
\caption{Evaluation of the usefullnes o fR for landscape ecology by the particpants of the survey. Answers were possible on a 5-point scale.}\label{fig:fig-usefulness}
\end{figure}

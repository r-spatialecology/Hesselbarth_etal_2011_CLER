...
Finally, there is a number of tools for landscape ecology implemented in some GIS software, such as ... for GRASS GIS or ... for ... .
Gladly, it is possible to control several GIS software directly from R using dedicated packages, such as *rgrass7* for ..., ... for ..., and *rgee* for Google Earth Engine.

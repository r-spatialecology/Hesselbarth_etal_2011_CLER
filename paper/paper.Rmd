...
Also the popular plotting package *ggplot2* \cite{Wickham2016} (Fig. \@ref(fig:fig-map)b) has an extension especially designed for plotting spatial data named *ggspatial* \cite{Dunnington2020}. 
\textcolor{blue}{Fore more information about **ggplot2** in general see \cite{Wickham2016}.
...
Both, *tmap* (Fig. \@ref(fig:fig-map)c) and *mapview* build upon the *leaflet* package and leaflet javascript library \cite{Cheng2021}.
...
(ref:capfigmap) Comparison of different options to create maps using a) base plot, b) *ggplot2* package, and c) *tmap* package. All maps show the total annual precipitation of Switzerland. Data were downloaded with the *raster* package (precipitation data) and *rnaturalearth* package (country borders) package. The code to create the maps can be found in the Appendix.

...
landscapes & Mosaics of land covers, ecosystems, habitat types, land uses \\
...
R packages & User-created software extension to R programming language \\
...
In landscape ecology, geostatistics has three key uses: i) detecting and correcting for spatial autocorrelation; ii) quantifying and comparing landscape pattern; iii) interpolating data. 

...
There are two major platforms to host *R* packages and make them easily accessible to potential users. Firstly, hosting the package on *GitHub* allows users to install it with only one line of code. 
...
However, there was a notable interest in spatial data analysis since the inception of this language, which is shown in a long R history of packages supporting spatial data (\cite{Lovelace2019}, page 10). <!--history section-->
...
The most prominent package allowing for raster data representation is *raster*.
A *raster* successor aimed at the simpler interface and improved performance, *terra*, is now being developed, however, it could take several years for this package to be adopted by users.
Alternatively, *stars* package can be used to read and process raster data.
It is interconnected with the *sf* package, and beside raster support, it provides tools for spatial data cubes.

The *sp* package was a standard for vector data representation for more than 10 years.
...
<!-- mention different data types/formats/projections/extents/resolutions -->
<!-- access to spatial data -->
<!-- rgee -->

## Spatial data processing

As we mentioned in the previous sections, obtained data can be represented by different data types and stored in various file formats and read into R using one of the packages from Section \@ref(sec:spatrep).
However, several potential obstacles to applying this data for ecological analysis still exist.

<!-- geographic/projected CRS -->
<!-- reprojecting -->
<!-- Different data can also used one of many coordinate reference systems (CRS) -->

<!-- different extents -->
<!-- cropping -->

<!-- the role of data preparation - changing resolution/simplifying, merging/joining -->

<!--MH: Short paragraph about scale; *grainchanger*; DOI: 10.1111/2041-210X.13177 -->

<!-- MH: landscapetools; DOI: 10.1111/2041-210X.13076 -->

<!-- JN: I am also thinking (unsure yet) about mentioning R as a bridge between other software (e.g. GRASSGIS) -->
<!-- rgee -->
<!-- MH: Maybe one short sentence that R allows to connect to other open-source software. We already introduce the topic previously anyhow -->
...
Alternatively, the *mapview* package can be used for quick interactive visualization of spatial data.
...
Both, *tmap* and *mapview* build upon the *leaflet* package and leaflet javascript library.<!--this sentence can be easily removed-->
R's general-purpose plotting package *ggplot2* together with its extension *ggspatial* also offers some capabilities for plotting spatial data.
...
Originated in the 1970s, SDM has experienced numerous methodological advancement and a numerous body of literature exists today \cite{Zimmermann2010}. Additionally, textbooks introducing  basic concepts of SDM in *R* exists \cite{Guisan2017,Fletcher2019}.

...
Also the popular plotting package *ggplot2* \cite{Wickham2016} has an extension especially designed for plotting spatial data named *ggspatial* \cite{Dunnington2020}.

...
```{r fig-workflow, echo = FALSE, out.width="100%", out.height="30%", fig.cap = "(ref:fig1cap)"}
...
```{r fig-map, echo = FALSE, out.width="100%", out.height="50%", fig.cap = "(ref:capfigmap)"}
...
```{r fig-survey, echo = FALSE, fig.align="center", fig.cap = "(ref:fig3cap)", warning=FALSE, out.width="100%"}

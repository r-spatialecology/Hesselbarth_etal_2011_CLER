...
\noindent \textbullet \textbullet \cite{Bivand2020}: Overview of general developments of *R* to analyze spatial data.

\noindent \textbullet \textbullet \cite{Lovelace2019}: Textbook about spatial data handling with applied examples in the *R* programming language.

\noindent \textbullet \cite{Lai2019}: Review of the *R* programming language in ecology.

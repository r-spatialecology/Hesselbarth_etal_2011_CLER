...
<!-- a paragraph or two about what are data representations, why do we need them, and what do they offer -->

<!-- two major data types - raster and vector -->

<!-- raster data representations -->
<!-- raster (+ mention terra) -->
<!-- stars -->

...
CRAN & Comprehensive R Archive Network. A repository for \textit{R} packages. \\
...
Also the popular plotting package *ggplot2* \cite{Wickham2016a} (Fig. \@ref(fig:fig-map)b) has an extension especially designed for plotting spatial data named *ggspatial* \cite{R-ggspatial}.
...
Both, *tmap* (Fig. \@ref(fig:fig-map)c) and *mapview* build upon the *leaflet* package and leaflet javascript library \cite{R-leaflet}.

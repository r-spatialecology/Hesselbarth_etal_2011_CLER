...
<!--JN: I like the second argument above. We can also add that the use of open-source software democratize scientific research (as opposed to the closed+expensive software) -->
...
<!--language is older (1991?), but in 1995 it was officially released for the first time-->
...
```{r fig-survey, echo = FALSE, fig.align="center", fig.cap = "Results of the online survey about open-source software tools in R for landscape ecology. Results include A) which terms describe major reserach topics the best, B) the most important workflow task, C) the most used R packages and D) the overall usefulnes or R for landscape ecology. 'others' includes all answers with less than five total mentions.", warning=FALSE}

...
ggplot_packages <- ggplot(data = r_packages_df) +
  ...
  labs(x = "Number of package mentioned [%]", y = NULL,
       title = "List the three R packages related to landscape\necology you use the most")
```
...
ggplot_tasks <- ggplot(data = tasks_df) +
  ...
  labs(x = "Number of task mentioned [%]", y = NULL,
       title = "Which are the most important tasks to your\nworkflow?")
```
...
```{r fig-usefulness, echo = FALSE, fig.align="center", fig.cap = "Evaluation of the usefullnes of R for landscape ecology by the particpants of the survey. Answers were possible on a 5-point scale."}

...
Since its first introduction in 1995, *R* has come a long way from a statistical programming language to a powerful tool for landscape ecology. 
...
However, since the scientific field of landscape ecology constantly changes and improves, also the *R* programming language and its packages need to change and adapt these changes.

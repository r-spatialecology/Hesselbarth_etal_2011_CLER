...
Nevertheless, the large availability and usage of different \textit{R} packages across the community can be seen in the large "others" option (packages mentioned by less than 5 participants; `r round(r_packages_df[[1, 2]], 2)`%).
...
Firstly, many participants (`r perc_performance`%) wished for a better computational performance of \textit{R} in terms of speed and required RAM, especially for larger data.

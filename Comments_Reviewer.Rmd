...
First, packages have different advantages and disadvantages that differ depending on e.g., the research question, the available data, or the personal preferences of the users.
...
**Reply**: We agree that the of Rayfield et al. 2011 is great, but we also want to point out that it was developed for a more specific topic (i.e., connectivity), while this manuscript deals with the whole field of landscape ecology.
...
**Reply**: We hope that the modified Figure 1, the added Box 1 and some added explanation in the conclusions explain how using R can facilitate a reproducible workflow in landcape ecology. \vskip 0.5cm
...
Since the survey is not the main idea of the manuscript though, we think that the survery still migth be interesting even with these shortcomings. \vskip 0.5cm
...
We reworded the sentence making clearea that indeed the community constantly improves the R programming language. 

...
We agree that a definition of landscape ecology is not needed given the target audience of the journal. 
Thus, we shortened the introduction. 
\textcolor{red}{Maybe move section of powerful R to introduction? But, comprehensive comparison with other software outside of scope} \vskip 0.5cm
...
\textcolor{red}{Refer to new how to get started box} \vskip 0.5cm
...
We made sure all packages should be included now. We also added the information to the table caption that not all packages from the manuscript are included but only packages specifically designed for spatial data and landscape ecology. \vskip 0.5cm
...
However, we believe that discussing underlying issues of R memory management is outside the scope if this paper. \vskip 0.5cm
